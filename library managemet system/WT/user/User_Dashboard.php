...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="issue_book.php">issue</a>
          <a class="dropdown-item" href="return_book.php">return</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="show_your_issue.php">your issue book</a>
        </div>
      </li>
              <li class="nav-item">
...
<div class="bd-example">
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item ">
        <img src="a (4).jpg" class="d-block w-100" alt="..."style="height: 600px">
        <div class="carousel-caption d-none d-md-block">
