...
<html>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4"><br><br><br>
            <h1 class="text-center text-primary login-title">Remove Book</h1>
            <div class="account-wall">
                
                <form class="form-signin" action="" method="post"><br>
                    <input type="text" class="form-control" placeholder="book ID" name="get_id" required><br>
...
<?php
                ...
                if(isset($_POST['submit']))
                {
                  ...
                  $b = "DELETE FROM books where Book_Id ='$id' ";
